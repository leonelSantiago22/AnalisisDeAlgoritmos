...
for numeroaInsertar in range(10000,0,-1):
...
'''range(inicio,final,salto)'''
for j in range(0,tamanoArreglo,1): #Ciclamos la iteraciones desde j = 2 hasta el tamano del arreglo
    key = Arreglo[j]
    i = j-1
...
print(tiempoFinal) #imprimimos el tiempo final de ejecucion en Segundos